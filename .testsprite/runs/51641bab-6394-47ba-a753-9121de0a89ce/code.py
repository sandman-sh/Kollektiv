...
async def run_test():
    ...
    try:
        ...
        # -> Type a unique username into the 'YOUR NAME' field and click the 'NEXT' button.
        # E.G. SARAH CHEN text field
        elem = page.get_by_placeholder('E.G. SARAH CHEN', exact=True)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.fill("User82714")
        ...
        # -> Click the 'NEXT' button to reveal the PIN entry fields.
        # NEXT button
        elem = page.get_by_role('button', name='NEXT', exact=True)
        await elem.click(timeout=10000)
        
        # -> Fill the four 'SET PIN' input boxes (labeled 'SET PIN') with the digits 1, 2, 3, 4 respectively.
        # password field
        ...
        # -> Fill the four 'CONFIRM PIN' input boxes with digits 1, 2, 3, and 4 respectively.
        # password field
        ...
        # Assert: Browser is redirected to /canvas.
        await expect(page).to_have_url(re.compile("/canvas"), timeout=15000), "Browser is redirected to /canvas."
