...
async def run_test():
    ...
    try:
        ...
        # -> Enter a unique username into the 'YOUR NAME' field and click the 'NEXT' button.
        # E.G. SARAH CHEN text field
        elem = page.get_by_placeholder('E.G. SARAH CHEN', exact=True)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.fill("User48392")
        
        # -> Enter a unique username into the 'YOUR NAME' field and click the 'NEXT' button.
        # Enter a unique username into the 'YOUR NAME' field and click the 'NEXT' button.
        elem = page.locator('xpath=/html/body/div/div/div/div[11]/div[2]/div/form/div[2]/div[3]')
        await elem.click(timeout=10000)
        
        # -> Click the 'NEXT' button on the join panel to reveal the PIN fields.
        # NEXT button
        elem = page.get_by_role('button', name='NEXT', exact=True)
        await elem.click(timeout=10000)
        
        # -> Fill the 'SET PIN' fields with digits 1, 2, 3, 4 (the four boxes under 'SET PIN').
        # password field
        ...
        # -> Fill the 'CONFIRM PIN' fields with digits 1, 2, 3, 4, then click the 'CREATE & ENTER' button
        # password field
        ...
        # Assert: The browser URL redirects to /canvas.
        await expect(page).to_have_url(re.compile("/canvas"), timeout=15000), "The browser URL redirects to /canvas."
